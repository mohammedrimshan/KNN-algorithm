...
Original file is located at
    https://colab.research.google.com/drive/1snn9iq0RxeQaO9jiA7DEqZJVTdcday6F
...
knn.predict([[3,5,4,2,2,3,4,6,7,9,7,4,5]])

knn.predict([[3,2.2,4.3,1.1,3,6,7,5,4,9,7,6,5]])

"""- Returns a NumPy array
- Can predict for multiple observations at once
"""

X_new = [[3,5,4,2,2,3,4,4,2,3,5,6,7],[5,4,3,2,7,1,2,4,5,6,5,4,3]]
knn.predict(X_new)
